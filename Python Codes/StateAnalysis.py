...
class StateAnalysis(YouthSmokingAnalysis):
    ...
    # def compare(self, set1, set2, title, legend_loc='lower left'):
    #     x1_values = []
    #     y1_values = []
    ...
    def analyzeCessation(self):
        ...
        self.plotResult(ds1, ds2, title='Cessation Rate (High School Students) - High Tax & Low Tax States',
    ...
    def analyzeCigaretteUse(self):
        ...
        ds2['desc'] = 'Low Tax States'
        self.plotResult(ds1, ds2, title='Smoking Rate (High School Students) - High Tax & Low Tax States',
    ...
    def analyzeBeforeAndAfterTax(self):
        ...
        plt.figure()
        plt.plot(x1_values, y1_values, linestyle='-', marker='.', color='b')
        plt.xlabel('Tax increase in cents')
        plt.ylabel('Decrease in smoking rate average')
        plt.title('Change in smoking rates by tax increase')
    ...
    def plotResult(self, set1, set2, title, filename, legend_loc='lower left'):
        x1_values = []
        y1_values = []
        for x, y in set1['data']:
            x1_values.append(x)
